...
| [fw-fanctrl-gui](https://github.com/jslay88/fw-fanctrl-gui) - Rust                                                | Feature rich GUI with a Fan Curve Editor, strategies manager, extra charging strategy selection, and system tray    | [<img src="https://raw.githubusercontent.com/jslay88/fw-fanctrl-gui/refs/heads/main/docs/screenshots/curve-editor.png" width="200">](https://github.com/jslay88/fw-fanctrl-gui)                                           |
...
> ⚠ **Linux Mint** and **Pop! OS** users should add the `--effective-installation-dir "/usr/local/bin"` option.
>
